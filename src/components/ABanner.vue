...
<style scoped>
.a-banner { --banner-color: var(--a-info); display: flex; align-items: center; justify-content: space-between; gap: 16px; min-height: 42px; padding: 7px 12px; background: color-mix(in srgb, var(--banner-color) 16%, var(--a-bg-surface)); color: var(--a-text-primary); border-bottom: 1px solid color-mix(in srgb, var(--banner-color) 24%, transparent); font-size: .82rem; }
.a-banner--green { --banner-color: var(--a-positive); }.a-banner--orange { --banner-color: var(--a-accent); }.a-banner--red { --banner-color: var(--a-negative); }.a-banner--yellow { --banner-color: var(--a-warning); }.a-banner--pink { --banner-color: #b65a85; }
...
.a-banner button { appearance: none; border: 0; border-radius: 6px; padding: 5px 7px; background: transparent; color: var(--a-text-secondary); font-weight: 650; cursor: pointer; }.a-banner button:hover { background: color-mix(in srgb, var(--banner-color) 12%, transparent); color: var(--a-text-primary); }
</style>
