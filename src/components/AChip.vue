...
<template>
  <q-chip
    ...
    :class="[`a-chip--${color}`, `a-chip--${size}`, `a-chip--${variant}`, { 'a-chip--selected': selected }]"
    :icon="icon"
    :removable="removable"
...
.a-chip--small { min-height: 24px; font-size: .72rem; }
.a-chip--large { min-height: 36px; font-size: .9rem; }
