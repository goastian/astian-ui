...
<style scoped>
.a-chip { --chip-color: var(--a-primary); margin: 0; border-radius: var(--a-radius-xs); background: color-mix(in oklch, var(--chip-color) 10%, var(--a-bg-raised)); color: var(--a-text-primary); font-weight: var(--a-font-weight-semibold); transition: background var(--a-motion-fast); }
.a-chip:hover { background: color-mix(in oklch, var(--chip-color) 16%, var(--a-bg-raised)); }
