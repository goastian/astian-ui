  ...
  <q-page class="a-page go-page">
    ...
    <div class="go-page__layout">
      ...
      <aside>
        ...
        <ASurface class="go-page__shortcuts"><strong>Accesos rápidos</strong><a href="#">Configuración de búsqueda <q-icon name="arrow_forward" /></a><a href="#">Informe de transparencia <q-icon name="arrow_forward" /></a></ASurface>
      </aside>
    </div>
  </q-page>
</template>
