...
import {
  ...
  AIcon, AIconButton, AIconText, AInput, AKeyCodeSequence, AMonoTag, APortal, ASelect,
  ASkeleton, ASurface, ATabs, ATextarea, AToast, AToggle, ATooltip, ATypography
} from '@/components'
...
<template>
  <q-page class="a-page design-system-page">
    ...
    <ADialog v-model="dialogOpen" title="Una decisión compartida" description="Este patrón funciona para confirmaciones y edición breve sin sacar a la persona de su contexto." icon="hub" type="confirm">
      <ATypography tone="secondary">Los componentes se publicarán desde <AMonoTag label="@astian/astian-ui" /> y cada producto podrá adoptar la base a su ritmo.</ATypography>
